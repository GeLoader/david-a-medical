...
@Component({
  selector: 'app-unpaid-advancecare',
  templateUrl: './unpaid-advancecare.component.html',
  styleUrls: ['./unpaid-advancecare.component.scss']
})
export class UnpaidAdvancecareComponent implements OnInit {
  constructor( 
  ...
  tableArr: any = [];
  displayedColumns: string[] = ['edit','delete','Line Number', 'File Name', 'Claim Id','Payment Date',
                                  'Item','Sales Order','Adv. Amount'];
