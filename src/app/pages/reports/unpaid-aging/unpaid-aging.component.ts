...
@Component({
  selector: 'app-unpaid-aging',
  templateUrl: './unpaid-aging.component.html',
  styleUrls: ['./unpaid-aging.component.scss']
})
export class UnpaidAgingComponent implements OnInit {
  constructor( 
  ...
  getUnpaidAgingReport() {
      this.reportsService.getUnpaidAgingReport().subscribe(
      (res: any) => {
